        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">Tambah Mata Pelajaran</h5>
                    <p class="m-b-0">Form Tambah Mata Pelajaran</p>
                </div>
            </div>
            <div class="col-md-4">
    ...
    <div class="main-body">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form class="form-material" action="{{route('mapel.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group form-primary">
                        ...
                        <label class="float-label">Nama Mata Pelajaran</label>
        ...
        if (name.trim() !== '') {
            ...
            .then(data => {
                if (data.field === 'name' && data.status === 'error') {
                    ...
                    feedback.textContent = 'Mapel tersedia.';

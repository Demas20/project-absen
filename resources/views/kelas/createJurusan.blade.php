        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">Tambah Jurusan</h5>
                    <p class="m-b-0">Form Tambah Jurusan</p>
                </div>
            </div>
            <div class="col-md-4">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="#!">Tambah Jurusan</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="main-body">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Form Tambah Jurusan</h5>
            </div>
            <div class="card-block">
                <form class="form-material" action="{{route('jurusan.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group form-primary">
                        ...
                        <label class="float-label">Nama Jurusan</label>
        ...
        if (name.trim() !== '') {
            ...
            .then(data => {
                if (data.field === 'name' && data.status === 'error') {
                    ...
                    feedback.textContent = 'Jurusan tersedia.';
